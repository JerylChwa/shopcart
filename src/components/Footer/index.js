  ...
  return (
        <footer className="text-gray-600 body-font border border-t-2">
            ...
            <div className="bg-gray-100">
                ...
                <p className="text-gray-500 text-sm text-center sm:text-left">© shopcart —
                    <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@www.shopcart.com</a>
                </p>
